...
const LIGHT_PRESETS: ColorScheme[] = [
  ...
  },
  {
    ...
    preset: true,
    priorities: {
      0: { stroke: '30 10% 62%',   fill: '30 8% 62%' },
      1: { stroke: '22 40% 55%',   fill: '22 35% 55%' },
      2: { stroke: '14 70% 53%',   fill: '14 62% 53%' },
      3: { stroke: '8 72% 46%',    fill: '8 65% 46%' },
    },
    accent: '14 70% 53%',
    lockedFill: '8 65% 42%',
    lockedText: '30 20% 96%',
  },
  {
    ...
    preset: true,
    priorities: {
      0: { stroke: '218 17% 78%', fill: '0 0% 98%' },
      1: { stroke: '230 58% 59%', fill: '0 0% 100%' },
      2: { stroke: '230 65% 60%', fill: '228 69% 32%' },
      3: { stroke: '231 65% 62%', fill: '226 52% 12%' },
    },
    accent: '230 80% 48%',
  ...
  },
  {
    ...
    priorities: {
      ...
      3: { stroke: '231 65% 62%', fill: '260 44% 22%' },
    },
    accent: '262 60% 50%',
  ...
  },
  {
    ...
    preset: true,
    priorities: {
      0: { stroke: '74 58% 85%',  fill: '0 0% 100%' },
      1: { stroke: '73 75% 62%',  fill: '0 0% 99%' },
      2: { stroke: '68 50% 52%',  fill: '68 67% 65%' },
      3: { stroke: '68 70% 83%',  fill: '67 45% 40%' },
    },
    accent: '72 75% 48%',
    lockedFill: '67 45% 40%',
    lockedText: '0 0% 100%',
