...
const DARK_PRESETS: ColorScheme[] = [
  {
    ...
    darkMode: true,
    priorities: {
      0: { stroke: '0 0% 42%',    fill: '0 0% 18%' },
      1: { stroke: '40 45% 52%',  fill: '40 25% 20%' },
      2: { stroke: '22 70% 55%',  fill: '22 45% 22%' },
      3: { stroke: '0 60% 55%',   fill: '0 40% 20%' },
    },
    accent: '12 76% 50%',
    lockedFill: '0 0% 90%',
    lockedText: '0 0% 8%',
  },
  {
    ...
    darkMode: true,
    priorities: {
      0: { stroke: '220 10% 38%', fill: '220 8% 14%' },
      1: { stroke: '215 15% 48%', fill: '215 10% 18%' },
      2: { stroke: '210 20% 58%', fill: '210 15% 22%' },
      3: { stroke: '0 55% 55%',   fill: '0 35% 20%' },
    },
    accent: '210 20% 58%',
    lockedFill: '0 0% 85%',
    lockedText: '0 0% 6%',
  },
  {
    ...
    darkMode: true,
    priorities: {
      0: { stroke: '220 20% 40%', fill: '220 15% 16%' },
      1: { stroke: '225 50% 55%', fill: '225 30% 20%' },
      2: { stroke: '230 70% 60%', fill: '230 45% 24%' },
      3: { stroke: '0 60% 58%',   fill: '0 38% 22%' },
    },
    accent: '230 70% 60%',
    lockedFill: '228 60% 65%',
    lockedText: '0 0% 5%',
  },
  {
    id: 'dark-amethyst',
    ...
    darkMode: true,
    priorities: {
      0: { stroke: '270 12% 40%', fill: '270 8% 15%' },
      1: { stroke: '265 35% 52%', fill: '265 20% 20%' },
      2: { stroke: '262 50% 58%', fill: '262 35% 24%' },
      3: { stroke: '0 60% 58%',   fill: '0 38% 22%' },
    },
    accent: '262 50% 58%',
    lockedFill: '265 40% 60%',
    lockedText: '0 0% 5%',
  },
  {
    id: 'dark-phosphor',
    ...
    darkMode: true,
    priorities: {
      0: { stroke: '120 22% 36%', fill: '120 12% 12%' },
      1: { stroke: '90 40% 45%',  fill: '90 22% 16%' },
      2: { stroke: '60 58% 48%',  fill: '60 35% 18%' },
      3: { stroke: '30 75% 52%',  fill: '30 50% 20%' },
    },
    accent: '120 30% 45%',
    lockedFill: '120 28% 50%',
    lockedText: '0 0% 5%',
  },
  {
    id: 'dark-ember',
    ...
    darkMode: true,
    priorities: {
      0: { stroke: '30 12% 38%',  fill: '30 8% 14%' },
      1: { stroke: '25 45% 48%',  fill: '25 28% 18%' },
      2: { stroke: '14 65% 52%',  fill: '14 42% 22%' },
      3: { stroke: '4 60% 55%',   fill: '4 40% 20%' },
    },
    accent: '14 65% 52%',
    lockedFill: '10 50% 55%',
    lockedText: '0 0% 5%',
