import {
  ...
  Caravan, Carrot, Cast, Cat, ChargingStation, ChartArea, ChartBar, ChartCandlestick,
  ...
  FirstAid, Fish, Flag, Flame, FlaskConical, FlipHorizontal, FlipVertical, Flower, Flower2,
  ...
  Scale, ScanFace, School, Scissors, ScreenShare, Screwdriver, ScrollText, Search, Send,
