        ...
        return (
          ...
          >
            <button
              ...
              className={`relative w-full overflow-hidden rounded-md border text-left shadow-[0_8px_30px_-4px_rgba(0,0,0,0.12),0_2px_8px_-2px_rgba(0,0,0,0.06)] transition-colors ${
                isActive
                  ? 'border-primary/60'
