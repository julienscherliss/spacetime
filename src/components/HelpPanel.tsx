...
import {
  ...
  DollarSign, FileText, Target, Users, Bell, Volume2,
  Palette, MessageSquare, Inbox, BookOpen, Boxes, Inbox as InboxIcon,
} from 'lucide-react';
...
const tips: HelpTip[] = [
  ...
  },
  {
    ...
    description: 'At the end of each day, a reflection prompt asks you to review what got done. Reflections are saved and surfaced in Analytics, where insights from past reflections help you spot patterns over time.',
    icon: <BookOpen size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['reflection', 'journal', 'review', 'daily', 'completion', 'end of day', 'insights'],
  },
  {
    id: 'billing',
    title: 'Billing & time tracking',
    description: 'Assign hourly rates to tags or subtags to automatically track billable time. Open Billing to see hours and revenue broken down by client and tag, with editable rates per subtag.',
    icon: <DollarSign size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['billing', 'rate', 'hourly', 'billable', 'revenue', 'money', 'time tracking', 'client'],
    openAction: 'toggle-billing',
    openLabel: 'Open Billing',
  },
  {
    id: 'invoices',
    title: 'Invoice generator',
    description: 'Generate styled invoices directly from your billable time. Pick a client and date range, choose a template (Minimal, Classic, Bold, Editorial, Compact), customize colors and typography, and export as PDF.',
    icon: <FileText size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['invoice', 'pdf', 'export', 'client', 'template', 'bill', 'generate'],
  },
  {
    id: 'clients',
    title: 'Clients',
    description: 'Group tags under clients for invoicing and reporting. Manage clients from the Billing panel — each client can own multiple tags, and Analytics can filter by client.',
    icon: <Users size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['client', 'customer', 'project', 'group', 'company'],
  },
  {
    id: 'goals',
    title: 'Weekly time goals',
    description: 'Set target hours per tag per week in Analytics. The Goals module shows progress bars for each tag so you can see at a glance whether you\'re on track with how you intend to spend your time.',
    icon: <Target size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['goal', 'target', 'weekly', 'hours', 'progress', 'budget', 'allocation'],
    openAction: 'toggle-analytics',
    openLabel: 'Open Analytics',
  },
  {
    id: 'send-to-library',
    title: 'Send tasks to the Library',
    description: 'Drag a scheduled task off the timeline and onto the Library drop zone to turn it into a reusable template. You\'ll be prompted to set a due date — leave blank to keep it open-ended.',
    icon: <InboxIcon size={16} strokeWidth={1.5} />,
    category: 'gestures',
    keywords: ['send', 'library', 'template', 'drop', 'zone', 'unschedule', 'save', 'due date'],
  },
  {
    id: 'groups',
    title: 'Task groups',
    description: 'Cluster related tasks together on the timeline. Groups stay visually unified and can be moved as a single block. Edit the group to rename, recolor, or break it apart into individual tasks.',
    icon: <Boxes size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['group', 'cluster', 'bundle', 'combine', 'series', 'block'],
  },
  {
    id: 'notifications',
    title: 'Task reminders',
    description: 'Get notified when tasks start and end. On native apps, system notifications fire even when the app is closed. In the browser, foreground reminders surface as in-app alerts. Toggle reminders in Settings.',
    icon: <Bell size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['notification', 'reminder', 'alert', 'push', 'native', 'browser', 'background'],
    openAction: 'toggle-settings',
    openLabel: 'Open Settings',
  },
  {
    id: 'sound-alerts',
    title: 'Sound alerts',
    description: 'Optional chimes play when tasks start, end, or you complete one. Pick a sound style and volume in Settings → Sounds. Mute entirely or use sparingly for the next task only.',
    icon: <Volume2 size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['sound', 'audio', 'chime', 'alert', 'volume', 'mute', 'cue'],
    openAction: 'toggle-settings',
    openLabel: 'Open Settings',
  },
  {
    id: 'color-schemes',
    title: 'Color schemes',
    description: 'Beyond light and dark mode, choose from curated color schemes that retint the entire interface while keeping the industrial aesthetic. Switch any time from Settings → Appearance.',
    icon: <Palette size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['color', 'scheme', 'theme', 'palette', 'tint', 'appearance', 'accent'],
    openAction: 'toggle-settings',
    openLabel: 'Open Settings',
  },
  {
    id: 'feedback',
    title: 'Send feedback',
    description: 'Found a bug or have an idea? Open Feedback from the overflow menu or Settings to send a note directly to the team. Include a screenshot if it helps explain the issue.',
    icon: <MessageSquare size={16} strokeWidth={1.5} />,
    category: 'features',
    keywords: ['feedback', 'bug', 'idea', 'report', 'suggestion', 'contact', 'support'],
    openAction: 'toggle-feedback',
